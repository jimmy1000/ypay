<?php /*a:2:{s:71:"/www/wwwroot/pay.xn--tnq769am5klza737gu1l.cn/view/index/doc/result.html";i:1656505428;s:71:"/www/wwwroot/pay.xn--tnq769am5klza737gu1l.cn/view/index/doc/header.html";i:1656962188;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
                ...
                <div class="doc-title-wrapper">
                    <div class="doc-title-row">
                        <h1 class="section-title" style="margin-bottom: 0px;">
                            <span style="font-weight: normal!important;">💶</span> 支付结果通知
                        </h1>
                    ...
                    <div class="api-row">
                        <div class="label-wrapper el-tag method-get method" style="margin-right: 5px; flex-wrap: unset;">
                            GET
                        </div>
                        <div class="label-wrapper api-path text-hidden" onclick="copyCode(this, true)" data-tips="服务器异步通知（notify_url）、页面跳转通知（return_url）">
                            <div class="text-hidden">服务器异步通知（notify_url）、页面跳转通知（return_url）</div>
                        </div>
...
<div class="param-list">
        ...
        <div class="param-list-item" data-children="0" data-level="0">
            <div class="param-list-row">
                ...
                <div class="param-list-row-item name">
                        <span class="label-wrapper required-param" onclick="copyCode(this, true)">trade_no</span>
                </div>
                <div class="param-list-row-item required">
                        <span class="td-span">必填</span>
                </div>
                ...
                <div class="param-list-row-item l4z7sh7h">
                    <span class="td-span" onclick="copyCode(this, true)">20160806151343349021</span>
                </div>
                <div class="param-list-row-item desc">
                    <span class="td-span" onclick="copyCode(this, true)">平台订单号</span>
                </div>
            </div>
        ...
        <div class="param-list-item" data-children="0" data-level="0">
            <div class="param-list-row">
                ...
                <div class="param-list-row-item desc">
                    <span class="td-span" onclick="copyCode(this, true)">商户系统内部的订单号</span>
                </div>
            </div>
        ...
        <div class="param-list-item" data-children="0" data-level="0">
            <div class="param-list-row">
                <div class="param-list-row-item l4z7s1sr">
                    <span class="td-span" onclick="copyCode(this, true)">支付状态</span>
                </div>
                <div class="param-list-row-item name">
                        <span class="label-wrapper required-param" onclick="copyCode(this, true)">trade_status</span>
                </div>
                <div class="param-list-row-item required">
                        <span class="td-span">必填</span>
                </div>
                ...
                <div class="param-list-row-item l4z7sh7h">
                    <span class="td-span" onclick="copyCode(this, true)">TRADE_SUCCESS</span>
                </div>
                <div class="param-list-row-item desc">
                    <span class="td-span" onclick="copyCode(this, true)">只有TRADE_SUCCESS是成功</span>
                </div>
            </div>
                        ...
                        <div class="bottom-nav-wrapper">
                            <div class="bottom-nav-row" style="display: flex;">
                                <div class="bottom-nav text-hidden">
                                    <a href="/doc/api" class="bottom-nav-link" data-id="69txTliB">上一篇 💴 API接口支付</a>
                                </div>
                                <div class="bottom-nav text-hidden">
                                    <a href="/doc/69892435/IIY3Lpy7/STMLK1Wg" class="bottom-nav-link" data-id="STMLK1Wg"></a>
                                </div>
                            </div>
                        </div>
                    </main>
