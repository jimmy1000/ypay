<?php /*a:1:{s:54:"/www/wwwroot/hm.otbax.cn/view/index/deal/moneylog.html";i:1653246108;}*/ ?>
        ...
        layui.use(['layer', 'form', 'laytpl', 'admin', 'table', 'laydate', 'util'], function () {
            ...
            var insTb = table.render({
                ...
                cols: [[
                    ...
                    { field: 'user_id', title: '商户ID', minWidth: 120, align: 'center' },
                    { field: 'money', title: '变更金额', minWidth: 120, sort: true, align: 'center' },
                    { field: 'beforemoney', title: '变化前金额', minWidth: 120, sort: true, align: 'center' },
                    { field: 'after', title: '变化后金额', minWidth: 120, sort: true, align: 'center' },
                    { field: 'memo', title: '变更类型', minWidth: 120, align: 'center' },
