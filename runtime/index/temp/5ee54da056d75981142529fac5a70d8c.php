<?php /*a:2:{s:70:"/www/wwwroot/pay.xn--tnq769am5klza737gu1l.cn/view/index/doc/index.html";i:1656505434;s:71:"/www/wwwroot/pay.xn--tnq769am5klza737gu1l.cn/view/index/doc/header.html";i:1656962188;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
  ...
  <main class="content-mid">
									...
									<div class="http-wrapper" data-active="0">
										...
										<article class="http-preview-container">
													...
													<div class="doc-title-wrapper">
														<div class="doc-title-row">
															...
															<div class="last-change">
																<a href="https://tools.fun/websocket.html"
																	target="_blank"
																	class="websocket-link">websocket测试</a>
															</div>
														</div>
														<div class="api-row">
															<div class="label-wrapper el-tag method-post method"
																style="margin-right: 5px; flex-wrap: unset;">
																POST
															</div>
															<div class="label-wrapper api-path text-hidden"
																onclick="copyCode(this, true)"
																data-tips="http://登录后接口配置里的域名/submit.php">
																<div class="text-hidden">http://登录后接口配置里的域名/submit.php
																</div>
															</div>
											...
											<section class="section-wrapper params">
												<div
													style="display: flex; align-items: center; flex-wrap: wrap; color: #909399;margin-bottom: 18px;">
													<h3 class="section-title"
														style="margin-bottom: 0; margin-right: 8px;;">请求参数</h3>
												...
												<div class="param-list-container">
													...
													<div class="param-list-wrapper">
														<div class="param-list">
															<div class="param-list-item" data-children="0"
																data-level="0">
																<div class="param-list-row">
																	<div class="param-list-row-item l4z7s1sr">
																		<span class="td-span"
																			onclick="copyCode(this, true)">商户ID</span>
																	</div>
																	<div class="param-list-row-item name">
																		<span class="label-wrapper required-param"
																			onclick="copyCode(this, true)">pid</span>
																	</div>
																	...
																	<div class="param-list-row-item type">
																		<span class="td-span"
																			onclick="copyCode(this, true)">Int</span>
																	</div>
																	<div class="param-list-row-item l4z7sh7h">
																		<span class="td-span"
																			onclick="copyCode(this, true)">1000</span>
																	</div>
															...
															<div class="param-list-item" data-children="0"
																...
																<div class="param-list-row">
																	<div class="param-list-row-item l4z7s1sr">
																		<span class="td-span"
																			onclick="copyCode(this, true)">支付方式</span>
																	</div>
																	<div class="param-list-row-item name">
																		<span class="label-wrapper required-param"
																			onclick="copyCode(this, true)">type</span>
																	</div>
																	<div class="param-list-row-item required">
																		<span class="td-span">必填</span>
																	</div>
																	<div class="param-list-row-item type">
																		<span class="td-span"
																			onclick="copyCode(this, true)">String</span>
																	</div>
																	<div class="param-list-row-item l4z7sh7h">
																		<span class="td-span"
																			onclick="copyCode(this, true)">alipay</span>
																	</div>
																	<div class="param-list-row-item desc">
																		<span class="td-span"
																			onclick="copyCode(this, true)">
																			支付方式：alipay:支付宝,qqpay:QQ钱包,wxpay:微信支付</span>
																	</div>
																</div>
															...
															<div class="param-list-item" data-children="0"
																...
																<div class="param-list-row">
																	<div class="param-list-row-item l4z7s1sr">
																		<span class="td-span"
																			onclick="copyCode(this, true)">商户订单号</span>
																	</div>
																	<div class="param-list-row-item name">
																		<span class="label-wrapper required-param"
																			onclick="copyCode(this, true)">out_trade_no</span>
																	</div>
																	<div class="param-list-row-item required">
																		<span class="td-span">必填</span>
																	</div>
																	...
																	<div class="param-list-row-item l4z7sh7h">
																		<span class="td-span"
																			onclick="copyCode(this, true)">20160806151343349</span>
																	</div>
																	<div class="param-list-row-item desc">
																		<span class="td-span"
																			onclick="copyCode(this, true)">商户订单号</span>
															...
															<div class="param-list-item" data-children="0"
																...
																<div class="param-list-row">
																	<div class="param-list-row-item l4z7s1sr">
																		<span class="td-span"
																			onclick="copyCode(this, true)">异步通知地址</span>
																	</div>
																	<div class="param-list-row-item name">
																		<span class="label-wrapper required-param"
																			onclick="copyCode(this, true)">notify_url</span>
																	</div>
																	<div class="param-list-row-item required">
																		<span class="td-span">必填</span>
																	</div>
																	...
																	<div class="param-list-row-item l4z7sh7h">
																		<span class="td-span"
																			onclick="copyCode(this, true)">http://站点域名/notify_url.php</span>
																	</div>
																	<div class="param-list-row-item desc">
																		<span class="td-span"
																			onclick="copyCode(this, true)">服务器异步通知地址</span>
																	</div>
																</div>
															...
															<div class="param-list-item" data-children="0"
																...
																<div class="param-list-row">
																	<div class="param-list-row-item l4z7s1sr">
																		<span class="td-span"
																			onclick="copyCode(this, true)">跳转通知地址</span>
																	</div>
																	<div class="param-list-row-item name">
																		<span class="label-wrapper required-param"
																			onclick="copyCode(this, true)">return_url</span>
																	</div>
																	<div class="param-list-row-item required">
																		<span class="td-span">必填</span>
																	</div>
																	...
																	<div class="param-list-row-item l4z7sh7h">
																		<span class="td-span"
																			onclick="copyCode(this, true)">http://站点域名/return_url.php</span>
																	</div>
																	<div class="param-list-row-item desc">
																		<span class="td-span"
																			onclick="copyCode(this, true)">页面跳转通知地址</span>
																	</div>
																</div>
															...
															<div class="param-list-item" data-children="0"
																...
																<div class="param-list-row">
																	<div class="param-list-row-item l4z7s1sr">
																		<span class="td-span"
																			onclick="copyCode(this, true)">商品名称</span>
																	</div>
																	<div class="param-list-row-item name">
																		<span class="label-wrapper required-param"
																			onclick="copyCode(this, true)">name</span>
																	</div>
																	<div class="param-list-row-item required">
																		<span class="td-span">必填</span>
																	</div>
																	...
																	<div class="param-list-row-item l4z7sh7h">
																		<span class="td-span"
																			onclick="copyCode(this, true)">一个奥利奥</span>
																	</div>
																	<div class="param-list-row-item desc">
																		<span class="td-span"
																			onclick="copyCode(this, true)">商品名称</span>
															...
															<div class="param-list-item" data-children="0"
																...
																<div class="param-list-row">
																	<div class="param-list-row-item l4z7s1sr">
																		<span class="td-span"
																			onclick="copyCode(this, true)">商品金额</span>
																	</div>
																	<div class="param-list-row-item name">
																		<span class="label-wrapper required-param"
																			onclick="copyCode(this, true)">money</span>
																	</div>
																	<div class="param-list-row-item required">
																		<span class="td-span">必填</span>
																	</div>
																	...
																	<div class="param-list-row-item l4z7sh7h">
																		<span class="td-span"
																			onclick="copyCode(this, true)">1.00</span>
																	</div>
																	<div class="param-list-row-item desc">
																		<span class="td-span"
																			onclick="copyCode(this, true)">商品金额</span>
															...
															<div class="param-list-item" data-children="0"
																...
																<div class="param-list-row">
																	<div class="param-list-row-item l4z7s1sr">
																		<span class="td-span"
																			onclick="copyCode(this, true)">签名字符串</span>
																	</div>
																	<div class="param-list-row-item name">
																		<span class="label-wrapper required-param"
																			onclick="copyCode(this, true)">sign</span>
																	</div>
																	<div class="param-list-row-item required">
																		<span class="td-span">必填</span>
																	</div>
																	...
																	<div class="param-list-row-item l4z7sh7h">
																		<span class="td-span"
																			onclick="copyCode(this, true)">202cb962ac59075b964b07152d234b70</span>
																	</div>
																	<div class="param-list-row-item desc">
																		<span class="td-span"
																			onclick="copyCode(this, true)">
																			签名字符串，签名算法与支付宝签名算法相同</span>
																	</div>
																</div>
															...
															<div class="param-list-item" data-children="0"
																...
																<div class="param-list-row">
																	<div class="param-list-row-item l4z7s1sr">
																		<span class="td-span"
																			onclick="copyCode(this, true)">签名类型</span>
																	</div>
																	<div class="param-list-row-item name">
																		<span class="label-wrapper required-param"
																			onclick="copyCode(this, true)">sign_type</span>
																	</div>
																	<div class="param-list-row-item required">
																		<span class="td-span">必填</span>
																	</div>
																	...
																	<div class="param-list-row-item l4z7sh7h">
																		<span class="td-span"
																			onclick="copyCode(this, true)">MD5</span>
																	</div>
																	<div class="param-list-row-item desc">
																		<span class="td-span"
																			onclick="copyCode(this, true)">默认为MD5</span>
																	</div>
																</div>
							...
							<div class="bottom-nav-wrapper">
								<div class="bottom-nav-row" style="display: flex;">
									<div class="bottom-nav text-hidden">
										<a href="" class="bottom-nav-link"></a>
									</div>
									<div class="bottom-nav text-hidden">
										<a href="/doc/api" class="bottom-nav-link"
											data-id="69txTliB">下一篇 💴 API接口支付</a>
									</div>
								</div>
		...
		<script>
			...
			if (appVersion.indexOf("Trident") !== -1) {
				...
				msg = '<h3><?php echo config('web.sitename'); ?>不支持当前浏览器，建议您使用 谷歌/Edge 浏览器，如果您使用的是兼容模式，请切换到非兼容模式</h3>';
