<?php /*a:3:{s:50:"/www/wwwroot/hm.otbax.cn/view/index/user/bind.html";i:1669958054;s:57:"/www/wwwroot/hm.otbax.cn/view/index/core/user_header.html";i:1669957192;s:56:"/www/wwwroot/hm.otbax.cn/view/index/core/reg_bottom.html";i:1669967482;}*/ ?>
<!doctype html>
<html lang="zh-CN">
	<head>
		<meta charset="UTF-8">
		...
		<title>补充信息 - <?php echo $config['sitename']; ?></title>
...
<div class="row">
	<div class="col-lg-12" style="display:none;">
		<div class="form-group position-relative">
			...
			<div class="input-group mb-3">
				<input type="text" class="form-control pl-3" placeholder="请输入账号" name="type" required=""
					value="<?php echo htmlentities($data['type']); ?>">
			</div>
		</div>
	</div>
	<div class="col-lg-12" style="display:none;">
		<div class="form-group position-relative">
			<label class="text-muted">sid *</label>
			<div class="input-group mb-3">
				<input type="text" class="form-control pl-3" placeholder="请输入账号" name="open_id" required=""
					value="<?php echo htmlentities($data['sid']); ?>">
			</div>
		</div>
	</div>
	<div class="col-lg-12" style="display:none;">
		<div class="form-group position-relative">
			<label class="text-muted">is_bind *</label>
			<div class="input-group mb-3">
				<input type="text" class="form-control pl-3" placeholder="请输入账号" name="is_bind" required=""
					value="<?php echo htmlentities($data['is_bind']); ?>">
			</div>
		</div>
	</div>
	<div class="col-lg-12">
		<div class="form-group position-relative">
			...
			<div class="input-group mb-3">
				<input type="text" class="form-control pl-3" placeholder="请输入账号" name="username" required=""
	...
	<div class="col-12 mb-2">
		<small class="text-muted">
			...
			注册登录即表示同意 <a class="btn-link" href="/">用户协议</a>、<a class="btn-link" href="/">隐私政策</a>
		</small>
	</div>
