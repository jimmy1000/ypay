<?php /*a:2:{s:49:"/mnt/projects/payyz/view/admin/ypay/plug/add.html";i:1669981298;s:49:"/mnt/projects/payyz/view/admin/common/common.html";i:1670898484;}*/ ?>
 <!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="mainBox">
        <div class="main-container">
            <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" class="layui-input layui-form-danger" name="downurl" type="text" value="<?php echo isset($model['downurl']) ? htmlentities($model['downurl']) : ""; ?>"/>
                    </div>
                </div>
        </div>
    </div>
