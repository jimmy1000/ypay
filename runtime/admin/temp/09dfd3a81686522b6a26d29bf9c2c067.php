<?php /*a:2:{s:73:"/www/wwwroot/pay.xn--tnq769am5klza737gu1l.cn/view/admin/ypay/vip/add.html";i:1669981354;s:74:"/www/wwwroot/pay.xn--tnq769am5klza737gu1l.cn/view/admin/common/common.html";i:1670898482;}*/ ?>
 <!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="main-container">
            ...
            <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" class="layui-input layui-form-danger" placeholder="例如:VIP"  name="name" type="text" value="<?php echo isset($model['name']) ? htmlentities($model['name']) : ""; ?>"/>
                    </div>
                </div>
            <div class="layui-form-item">
                    <label class="layui-form-label">
                    ...
                    <div class="layui-input-block">
                        <input type="text" class="layui-input layui-form-danger" placeholder="费率范围设置项:0-100" name="feilv" type="text" value="<?php echo isset($model['feilv']) ? htmlentities($model['feilv']) : ""; ?>"/>
                    </div>
                </div>
            <div class="layui-form-item">
                    <label class="layui-form-label">
            ...
            <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" class="layui-input layui-form-danger" placeholder="填写实际数字即可" name="viptime" type="text" value="<?php echo isset($model['viptime']) ? htmlentities($model['viptime']) : ""; ?>"/>
                    </div>
                </div>
            <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
            <legend>额外功能</legend>
            ...
            <!--<div class="layui-input-block">-->
            <!--  <input type="checkbox" name="is_premium" lay-skin="switch" lay-text="开|关" lay-filter="premium">-->
            <!--</div>-->
            <!--  </div>-->
              ...
              <!--      </label>-->
              <!--      <div class="layui-input-block">-->
              <!--          <input type="text" class="layui-input layui-form-danger" placeholder="范围设置项:0-100,为百分比" name="premium_discount" type="text" />-->
              <!--      </div>-->
              <!--  </div>-->
              <!--</div>-->
              <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="checkbox" name="is_quota" lay-skin="switch" lay-text="开|关" lay-filter="quota">
            </div>
              </div>
              <div id="quota" style="display:none;"> 
                    ...
                    <div class="layui-input-block">
                        <input type="text" class="layui-input layui-form-danger" name="today_quota"/>
                    </div>
                </div>
              </div>
              <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="checkbox" name="is_passage" lay-skin="switch" lay-text="开|关" lay-filter="passage">
            </div>
              </div>
