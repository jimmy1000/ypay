...
$download_url=[
    'unix'=>[
        'nosafety'=>[
            '7.3'=>'https://compiler.swoole.com/static/loader3.0.0/swoole_loader73.so',
            '7.4'=>'https://compiler.swoole.com/static/loader3.1.0/swoole_loader74.so',
        ...
        'safety'=>[
            '7.3'=>'https://compiler.swoole.com/static/loader3.0.0/swoole_loader73_zts.so',
            '7.4'=>'https://compiler.swoole.com/static/loader3.1.0/swoole_loader74_zts.so',
    ...
    // 'windows'=>[
    //     'nosafety'=>[
    //         '5.6'=>'https://business.swoole.com/static/loader2.2.0/php_swoole_loader_php56_nzts_x64.dll',
    //         '7.0'=>'https://business.swoole.com/static/loader2.2.0/php_swoole_loader_php70_nzts_x64.dll',
    //         '7.1'=>'https://business.swoole.com/static/loader2.2.0/php_swoole_loader_php71_nzts_x64.dll',
    //         '7.2'=>'https://business.swoole.com/static/loader2.2.0/php_swoole_loader_php72_nzts_x64.dll',
    //         '7.3'=>'https://business.swoole.com/static/loader2.2.0/php_swoole_loader_php73_nzts_x64.dll',
    ...
    //     ],
    //     'safety'=>[
    //         '5.6'=>'https://business.swoole.com/static/loader2.2.0/php_swoole_loader_php56_zts_x64.dll',
    //         '7.0'=>'https://business.swoole.com/static/loader2.2.0/php_swoole_loader_php70_zts_x64.dll',
    //         '7.1'=>'https://business.swoole.com/static/loader2.2.0/php_swoole_loader_php71_zts_x64.dll',
    //         '7.2'=>'https://business.swoole.com/static/loader2.2.0/php_swoole_loader_php72_zts_x64.dll',
    //         '7.3'=>'https://business.swoole.com/static/loader2.2.0/php_swoole_loader_php73_zts_x64.dll',
...
if ('web' == $env['php']['run_mode']) {
    ...
    $html_body_nav .= '<p>（YPay需要Swoole Compiler加密扩展）<br>如果您环境是虚拟主机不支持自定义安装php扩展。<br>请去FTP或者文件管理删除YPay目录即可恢复网站。</p>';
    $html_body_nav .=  '</div>';
    ...
    <p style="text-align: center; font-size: 13px;">CopyRight © '. date('Y') . ' <a href="https://www.yfx.top/" target="_blank" class="text-success">www.yfx.top</a> YPay加密扩展安装引导助手 如有不懂会员群交流</p>
  </footer>';
